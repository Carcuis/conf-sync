...
alias termux='ssh -p 8022 192.168.137.67'
alias xytermux='ssh -p 8022 10.44.68.197'
alias tubuntu='ssh -p 2235 192.168.43.1'
alias xytubuntu='ssh -p 2235 10.44.68.197'
alias aliyun='LANG="en_US.UTF-8" ; ssh -p 2235 cui@47.107.62.60'
alias aliyunroot='LANG="en_US.UTF-8" ; ssh -p 2235 root@47.107.62.60'
alias aliyunzh='LANG="zh_CN.UTF-8" ; ssh -p 2235 cui@47.107.62.60 ; LANG="en_US.UTF-8"'
alias aliyunrootzh='LANG="zh_CN.UTF-8" ; ssh -p 2235 root@47.107.62.60 ; LANG="en_US.UTF-8"'
